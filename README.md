...
Ao terminar a instalação é só logar com os dados padrão, caso não saiba veja na página do projeto [Press Ticket aqui](https://github.com/matheuslopes125/Press-Ticket).

## INSTALAÇÃO 
FAZENDO DOWNLOAD DO INSTALADOR & INICIANDO A PRIMEIRA INSTALAÇÃO (USAR SOMENTE PARA PRIMEIRA INSTALAÇÃO):

```bash
sudo apt install -y git && git clone https://github.com/matheuslopes125/install_pressticket-phpmyadmin.git instalador && sudo chmod -R 777 ./instalador && cd ./instalador && sudo ./install_primaria
```
...
```
## Recursos 
- Multi instalador ilimitado [Press Ticket](https://github.com/matheuslopes125/Press-Ticket)
...
## Versão Debian
- [Press-Ticket-Installer](https://github.com/matheuslopes125/Press-Ticket-Installer)

## Instalação manual
- [Press Ticket](https://github.com/matheuslopes125/Press-Ticket)
